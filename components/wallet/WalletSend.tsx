                            ...
                            <div class="bg-gradient-to-br from-[#1c1c21] to-[#111113] border border-white/10 rounded-[32px] p-8 text-center shadow-3xl">
                                ...
                                <div class="mt-8 pt-8 border-t border-white/[0.04] space-y-4">
                                    <div class="flex justify-between items-center px-2">
                                        ...
                                        <span class="text-sm font-mono text-white bg-white/5 px-3 py-1.5 rounded-lg border border-white/5">{props.recipientAddress().slice(0, 10)}...{props.recipientAddress().slice(-10)}</span>
                                    </div>
                                    <div class="flex justify-between items-center px-2">
