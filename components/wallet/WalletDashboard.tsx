            ...
            <div class="flex-1 flex flex-col overflow-hidden relative">
                ...
                >
                    <Show when={props.messages().length === 0}>
                        <div class="flex flex-col items-center justify-start p-6 pt-20 md:pt-32 w-full max-w-2xl mx-auto z-10 pb-96 md:pb-64 min-w-0" style="box-sizing: border-box;">
