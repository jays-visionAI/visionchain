                        ...
                        <div class="flex flex-col items-center gap-3">
                            ...
                            <div class="flex gap-3 justify-center">
                                <button onClick={() => { stopWalkAnim(); setPhase('ready'); setShowReward(false); setCurrentFloor(0); }}
                                    ...
                                    class={`px-6 py-3 border rounded-xl text-sm font-bold transition-all ${props.playsRemaining && props.playsRemaining() <= 0 ? 'bg-gray-800/50 border-gray-700/30 text-gray-600 cursor-not-allowed' : 'bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 border-emerald-500/30 text-emerald-400 hover:bg-emerald-500/30'}`}
                                    style="touch-action: manipulation;">
