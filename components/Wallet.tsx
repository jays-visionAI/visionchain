                    ...
                    <main class={`flex-1 flex flex-col h-screen transition-all duration-300 relative ml-0 lg:ml-[280px] w-full overflow-x-hidden ${onboardingStep() === 0 ? 'pb-[68px] lg:pb-0' : ''}`}>
                        ...
                        <Suspense fallback={
                            <div class="flex-1 flex items-center justify-center p-20">
                                <div class="flex flex-col items-center gap-4">
                                    <div class="animate-spin w-12 h-12 border-4 border-blue-500 border-t-transparent rounded-full shadow-[0_0_15px_rgba(59,130,246,0.5)]" />
                                    <div class="text-gray-500 text-[10px] font-black tracking-[0.2em] uppercase animate-pulse">Initializing Layer...</div>
                                </div>
                            </div>
                        }>
                            {/* Chat View */}
