                        ...
                        <section class="bg-[#0B0E14] border border-white/5 rounded-3xl p-8 glass-panel shadow-2xl">
                            ...
                            <ul class="space-y-6">
                                <li class="relative pl-8">
                                    ...
                                    <p class="text-xs text-slate-500 leading-relaxed">Add Vision Chain v2 manually. **Chain ID: 3151909**, RPC: `https://api.visionchain.co/rpc-proxy`. Use VCN for gas.</p>
                                </li>
                                <li class="relative pl-8">
