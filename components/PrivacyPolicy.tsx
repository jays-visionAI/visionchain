      ...
      <div className="max-w-[800px] mx-auto">
        ...
        >
            <div className="flex items-center gap-3 mb-6">
                ...
                <h1 className="text-4xl md:text-5xl font-semibold text-white tracking-tight">Privacy Policy</h1>
            </div>
            ...
            <Section title="5. Security of Your Information">
             ...
             <Section title="6. Contact Us">
                ...
                <div className="mt-4 p-4 bg-white/5 rounded-lg border border-white/5 inline-block">
                    <p className="text-white font-medium">Vision Chain Foundation</p>
                    <p className="text-gray-400">123 Blockchain Blvd, Suite 100</p>
                    <p className="text-gray-400">Crypto Valley, Zug</p>
                </div>
            </Section>
