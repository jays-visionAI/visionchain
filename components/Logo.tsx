...
const Logo = (props: LogoProps): JSX.Element => {
  return (
    <div class="flex items-center gap-2.5 select-none">
      {/* Vision Chain coin badge — node mark on a dark navy circle */}
      <svg
        viewBox="0 0 512 512"
        fill="none"
