...
export const getAudioContext = () => new (window.AudioContext || (window as any).webkitAudioContext)({ sampleRate: 16000 });

export const getAiInstance = (apiKey: string) => new GoogleGenAI({ apiKey });
