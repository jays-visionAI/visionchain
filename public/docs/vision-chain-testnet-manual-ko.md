...
### 1. 지갑 준비 (메타마스크)
1.  브라우저용 [메타마스크(MetaMask)](https://metamask.io/)를 다운로드하여 설치합니다.
2.  새 지갑을 생성하고 **복구 구문(12단어)**을 안전하게 백업하세요.

### 2. 비전체인 v2 연결하기
1.  메타마스크 실행 -> 상단 네트워크 선택 클릭 -> **[네트워크 수동 추가]** 클릭.
2.  아래 정보를 그대로 입력하세요:
    -   **네트워크 이름**: Vision Testnet v2
    -   **RPC URL**: `http://46.224.221.201:8545`
    -   **체인 ID**: `1001`
    -   **통화 기호**: `VCN`
    -   **블록 탐색기**: `https://www.visionchain.co/visionscan`
